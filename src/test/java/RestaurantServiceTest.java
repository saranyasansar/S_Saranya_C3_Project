...
class RestaurantServiceTest {
    ...
    public void restaurant_adding_for_testing(){
        ...
        service.addRestaurant("Bowl Company","chennai",LocalTime.parse("10:30:00"),LocalTime.parse("22:00:00"));
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        ...
        assertThrows(restaurantNotFoundException.class,()->{service.findRestaurantByName("Ameliee");});
    }
    //<<<<<<<<<<<<<<<<<<<<SEARCHING>>>>>>>>>>>>>>>>>>>>>>>>>>
